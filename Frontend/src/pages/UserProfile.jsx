...
const UserProfile = () => {
  ...
  const { user, profileData } = useSelector(
  ...
  return (
    <div className="bg-gray-900 w-full min-h-screen flex flex-col  items-center px-4 md:px-10 py-5">
    ...
    <div>
        <button onClick={handleLogOut} className="bg-blue-600 text-white  top-5 right-5 px-3 cursor-pointer py-1 font-semibold  rounded-xl ">
          LogOut
        </button>
      </div>
      </div>
      {profileData ? (
        <div className="text-white  flex flex-col gap-2 px-1 py-5 md:w-[550px] w-full">
          ...
          <div className="md:px-15 w-full md:gap-10 mt-5 flex justify-between items-center">
            <div className="w-22 h-22 md:w-32 md:h-32 rounded-full ">
              <img
              ...
              <div className="flex gap-10 mt-3">
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-center gap-4">
                    <div className=" gap-1 hidden relative">
              ...
              <div className="flex gap-10 overflow-auto">
                {suggestedUser &&
                  suggestedUser.slice(0, 10).map((user) => {
                    return (
                      <div className="bg-white shadow-sm text-black rounded-lg shadow-black/40 w-[200px] border-2 border-black/50 py-2 px-1 justify-between items-center flex flex-col gap-2">
                        <img
          ...
          <div className="w-full bg-white min-h-screen flex flex-col items-center mt-5 pb-5 rounded-tl-4xl rounded-tr-4xl">
            {
              profileData._id === user._id && <div className=" flex w-full justify-between px-3 gap-5 pt-10">
